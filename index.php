...
<body>
  ...
  <div id="siteBox">
    ...
    <div id="content">
      ...
      <div id="contentRight" style="font-size: 16px;">

        <p>
          <span class="header" style="font-size: 20px;">Selamat Datang di Pemilihan Karyawan Terbaik menggunakan Metode WP</span>
        </p>

        <p style="font-size: 16px;">
          Di sini Anda dapat mengevaluasi dan memilih karyawan terbaik berdasarkan Metode Weighted Product (WP). Gunakan menu di sebelah kiri untuk navigasi dan akses ke berbagai fitur aplikasi.
        </p>
